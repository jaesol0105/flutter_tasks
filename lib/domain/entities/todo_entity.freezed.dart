...
mixin _$TodoEntity {
 ...
 String get id; String get title; String? get description; bool get isFavorite; bool get isDone; DateTime? get createdAt; DateTime? get deadLine;
...
@useResult
$Res call({
 String id, String title, String? description, bool isFavorite, bool isDone, DateTime? createdAt, DateTime? deadLine
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String? description,  bool isFavorite,  bool isDone,  DateTime? createdAt,  DateTime? deadLine)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TodoEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String? description,  bool isFavorite,  bool isDone,  DateTime? createdAt,  DateTime? deadLine)  $default,) {final _that = this;
switch (_that) {
case _TodoEntity():
return $default(_that.id,_that.title,_that.description,_that.isFavorite,_that.isDone,_that.createdAt,_that.deadLine);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String? description,  bool isFavorite,  bool isDone,  DateTime? createdAt,  DateTime? deadLine)?  $default,) {final _that = this;
switch (_that) {
case _TodoEntity() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.isFavorite,_that.isDone,_that.createdAt,_that.deadLine);case _:
  return null;
...
class _TodoEntity implements TodoEntity {
  const _TodoEntity({required this.id, required this.title, this.description, required this.isFavorite, required this.isDone, this.createdAt, this.deadLine});
