...
class _WeatherEntity implements WeatherEntity {
  const _WeatherEntity({@JsonKey(name: 'temperature_2m') required this.temperature, @JsonKey(name: 'wind_speed_10m') required this.windSpeed, @JsonKey(name: 'weather_code', fromJson: _convertWeatherCode) required this.weatherDescription, @JsonKey(name: 'is_day') required this.isDay, @JsonKey(fromJson: _convertToDateTime) required this.time});
  factory _WeatherEntity.fromJson(Map<String, dynamic> json) => _$WeatherEntityFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$WeatherEntityToJson(this, );
}
